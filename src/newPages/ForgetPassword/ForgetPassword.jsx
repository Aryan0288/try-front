...
export const ForgetPassword = () => {
    ...
    async function handleSubmit(e) {
        try {
            setClicked(true);
            console.log("I am in forgetpassword");
            e.preventDefault();
            var res = await axios.post("/forgetpassword", { email });
            toast.success("send ResetPassword Email");
            console.log(res);
            setClicked(false);
        } catch (err) {
            setClicked(false);
        ...
        <div className='w-8/12 mx-auto'>
            <div className="container">
                ...
                <form method="post" onSubmit={handleSubmit}>
                    ...
                    <button disabled={clicked} type="submit" className='btn'>
                        Reset Password
                    </button>
                    {
